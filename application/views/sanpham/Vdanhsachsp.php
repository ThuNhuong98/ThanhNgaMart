								...
								{foreach $danhsachsp as $value}
									<tr>
										...
										<td>
											...
											<button type="button" class="btn btn-xs btn-success" name="set_km" title="Thiết lập khuyến mại sản phẩm" value="{$value.PK_sMaSP}" data-toggle="modal" data-target="#mySale">
												<i class="fa fa-wrench" aria-hidden="true"></i>
											</button>
											{/if}
											<button type="button" class="btn btn-xs btn-danger" name="huysp" title="Huỷ sản phẩm" value="{$value.PK_sMaSP}" data-toggle="modal" data-target="#destroyProd">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label class="col-sm-4 control-label">Nhóm sản phẩm:</label>
								<div class="col-sm-8">
									<select class="form-control m-b" name="nhomsp">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">Tên sản phẩm:</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="tensp" value="" required="true">
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label">Giá bán:</label>
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">Nhà sản xuất:</label>
								<div class="col-sm-8">
									<select class="form-control m-b" name="nhasx">
...
<form method="POST" class="form-horizontal" enctype="multipart/form-data">
	<div class="modal fade" id="destroyProd" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document" style="width: 1000px;">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					...
					<h3 class="modal-title">Huỷ sản phẩm</h3>
				</div>
				<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary btnmodal" name="btnHuySp" value="">Lưu</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
				</div>
			</div>
		</div>
